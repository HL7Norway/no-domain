...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile NoDomainVitalSignsObservationBodyWeight
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Observation">
      ...
      <sch:assert test="count(f:extension[@url = 'http://hl7.no/fhir/StructureDefinition/NoDomainVitalSignsObservationClothingStateExtension']) &lt;= 1">extension with URL = 'http://hl7.no/fhir/StructureDefinition/NoDomainVitalSignsObservationClothingStateExtension': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://hl7.no/fhir/StructureDefinition/no-domain-vitalsignsobservation-confoundingfactorextension']) &lt;= 1">extension with URL = 'http://hl7.no/fhir/StructureDefinition/no-domain-vitalsignsobservation-confoundingfactorextension': maximum cardinality of 'extension' is 1</sch:assert>
