...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile NoDomainVitalSignsObservationOxygenSaturation
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Observation">
      ...
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/StructureDefinition/NoDomainVitalSignsObservationPrePostduktalExtension']) &lt;= 1">extension with URL = 'http://hl7.org/fhir/StructureDefinition/NoDomainVitalSignsObservationPrePostduktalExtension': maximum cardinality of 'extension' is 1</sch:assert>
