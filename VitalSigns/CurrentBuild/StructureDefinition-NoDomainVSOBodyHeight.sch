...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Observation">
      <sch:assert test="count(f:extension[@url = 'http://hl7.no/fhir/StructureDefinition/no-domain-vso-bodyheight-bodyposition-extension']) &lt;= 1">extension with URL = 'http://hl7.no/fhir/StructureDefinition/no-domain-vso-bodyheight-bodyposition-extension': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
