...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Observation">
      <sch:assert test="count(f:extension[@url = 'http://hl7.no/fhir/StructureDefinition/no-domain-vso-bodyexposure-extension']) &lt;= 1">extension with URL = 'http://hl7.no/fhir/StructureDefinition/no-domain-vso-bodyexposure-extension': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://hl7.no/fhir/StructureDefinition/no-domain-vso-dayssincemenstruationstart-extension']) &lt;= 1">extension with URL = 'http://hl7.no/fhir/StructureDefinition/no-domain-vso-dayssincemenstruationstart-extension': maximum cardinality of 'extension' is 1</sch:assert>
      ...
      <sch:assert test="count(f:extension[@url = 'http://hl7.no/fhir/StructureDefinition/no-domain-vso-activeheating-extension']) &lt;= 1">extension with URL = 'http://hl7.no/fhir/StructureDefinition/no-domain-vso-activeheating-extension': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
