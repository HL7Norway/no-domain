...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Observation">
      ...
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/StructureDefinition/no-domain-vso-heartrhythmextension']) &lt;= 1">extension with URL = 'http://hl7.org/fhir/StructureDefinition/no-domain-vso-heartrhythmextension': maximum cardinality of 'extension' is 1</sch:assert>
      ...
      <sch:assert test="count(f:extension[@url = 'http://hl7.no/fhir/StructureDefinition/no-domain-vso-characterofheartrateextension']) &lt;= 1">extension with URL = 'http://hl7.no/fhir/StructureDefinition/no-domain-vso-characterofheartrateextension': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/StructureDefinition/no-domain-vso-heartrate-bodypositionextension']) &lt;= 1">extension with URL = 'http://hl7.org/fhir/StructureDefinition/no-domain-vso-heartrate-bodypositionextension': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/StructureDefinition/no-domain-vso-heartrhythmIrregularityextension']) &lt;= 1">extension with URL = 'http://hl7.org/fhir/StructureDefinition/no-domain-vso-heartrhythmIrregularityextension': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
