...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Observation">
      ...
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/StructureDefinition/no-domain-vso-prepostduktalextension']) &lt;= 1">extension with URL = 'http://hl7.org/fhir/StructureDefinition/no-domain-vso-prepostduktalextension': maximum cardinality of 'extension' is 1</sch:assert>
