...
| Draft as of 2026-06-26 | *Computable Name*:NoDomainVitalSignsMethodofOxygenDeliveryExtension |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/hl7.fhir.no.domain.vitalsigns|current/StructureDefinition/StructureDefinition-NoDomainVitalSignsMethodofOxygenDeliveryExtension.json)
