# NoDomainVitalSignsPulseRhythmIrregularity-Extension - v0.9.71

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **NoDomainVitalSignsPulseRhythmIrregularity-Extension**

## Extension: NoDomainVitalSignsPulseRhythmIrregularity-Extension 

| | |
| :--- | :--- |
| *Official URL*:http://hl7.no/fhir/no-domain/vitalsigns/StructureDefinition/NoDomainVitalSignsPulseRhythmIrregularityExtension | *Version*:0.9.71 |
...
Other representations of profile: [CSV](StructureDefinition-NoDomainVitalSignsPulseRhythmIrregularityExtension.csv), [Excel](StructureDefinition-NoDomainVitalSignsPulseRhythmIrregularityExtension.xlsx), [Schematron](StructureDefinition-NoDomainVitalSignsPulseRhythmIrregularityExtension.sch) 
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      "id" : "Extension.url",
      "path" : "Extension.url",
      "fixedUri" : "http://hl7.no/fhir/no-domain/vitalsigns/StructureDefinition/NoDomainVitalSignsPulseRhythmIrregularityExtension"
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "http://hl7.no/fhir/no-domain/vitalsigns/ValueSet/NoDomainVitalSignsPulseRhythmIrregularityValueSet"
      }
    }]
  }
}
