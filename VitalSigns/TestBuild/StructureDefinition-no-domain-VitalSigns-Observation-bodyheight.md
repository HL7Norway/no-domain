# no-domain-VitalSigns-Observation-bodyheight Profile - v0.9.5
...
| | |
| :--- | :--- |
| *Official URL*:http://hl7.no/fhir/no-domain/vitalsigns/StructureDefinition/no-domain-VitalSigns-Observation-bodyheight | *Version*:0.9.5 |
