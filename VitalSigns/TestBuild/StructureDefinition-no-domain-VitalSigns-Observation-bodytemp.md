# no-domain-VitalSigns-Observation-bodytemp Profile - v0.9.73
...
| | |
| :--- | :--- |
| *Official URL*:http://hl7.no/fhir/no-domain/vitalsigns/StructureDefinition/no-domain-VitalSigns-Observation-bodytemp | *Version*:0.9.73 |
