# no-domain-VitalSigns-Observation-bodyweight Profile - v0.9.72
...
| | |
| :--- | :--- |
| *Official URL*:http://hl7.no/fhir/no-domain/vitalsigns/StructureDefinition/no-domain-VitalSigns-Observation-bodyweight | *Version*:0.9.72 |
