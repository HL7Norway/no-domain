# no-domain-VitalSigns-Observation-pulse Profile - v0.9.6
...
| | |
| :--- | :--- |
| *Official URL*:http://hl7.no/fhir/no-domain/vitalsigns/StructureDefinition/no-domain-VitalSigns-Observation-pulse | *Version*:0.9.6 |
