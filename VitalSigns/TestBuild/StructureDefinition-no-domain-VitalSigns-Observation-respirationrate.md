# no-domain-VitalSigns-Observation-respirationrate Profile - v0.9.6
...
| | |
| :--- | :--- |
| *Official URL*:http://hl7.no/fhir/no-domain/vitalsigns/StructureDefinition/no-domain-VitalSigns-Observation-respirationrate | *Version*:0.9.6 |
