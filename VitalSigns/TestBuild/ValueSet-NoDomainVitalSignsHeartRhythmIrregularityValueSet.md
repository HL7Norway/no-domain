# NoDomainVitalSignsHeartRhythmIrregularity-ValueSet - v0.9.74
...
| | | |
| :--- | :--- | :--- |
| *Official URL*:http://hl7.no/fhir/no-domain/vitalsigns/ValueSet/NoDomainVitalSignsHeartRhythmIrregularityValueSet | *Version*:0.9.74 | |
...
```json
{
  ...
  "id" : "NoDomainVitalSignsHeartRhythmIrregularityValueSet",
  "meta" : {
  ...
  "url" : "http://hl7.no/fhir/no-domain/vitalsigns/ValueSet/NoDomainVitalSignsHeartRhythmIrregularityValueSet",
  "version" : "0.9.74",
  "name" : "NoDomainVitalSignsHeartRhythmIrregularityValueSet",
