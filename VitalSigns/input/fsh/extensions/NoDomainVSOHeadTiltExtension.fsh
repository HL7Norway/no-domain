Extension: NoDomainVSOHeadTiltExtension
Id: NoDomainVSOHeadTiltExtension
Description: "The craniocaudal tilt of the surface on which the person is lying at the time of measurement."
* ^url = "http://hl7.no/fhir/StructureDefinition/no-domain-vso-headtiltextension"
* ^version = "0.9.0000"
* ^status = #draft
* ^date = "2021-05-01"
* ^context.type = #element
* ^context.expression = "Observation"
* url = "http://hl7.no/fhir/StructureDefinition/no-domain-vso-headtiltextension" (exactly)
