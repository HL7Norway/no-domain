...
* value[x] from $no-domain-vitalsignsobservation-respirationrate-patternvalueset (required)
* value[x].coding ..1
* value[x].coding from $no-domain-vitalsignsobservation-respirationrate-patternvalueset (required)