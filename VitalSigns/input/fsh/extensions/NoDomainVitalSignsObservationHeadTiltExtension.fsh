Extension: NoDomainVitalSignsObservationHeadTiltExtension
Id: NoDomainVitalSignsObservationHeadTiltExtension
...
* url = "http://hl7.no/fhir/StructureDefinition/no-domain-vitalsignsobservation-headtiltextension" (exactly)
