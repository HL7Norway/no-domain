...
* extension[0].url = "http://hl7.no/fhir/StructureDefinition/no-domain-vso-levelofexertionextension"
* extension[=].valueCoding = $sct#154h "Hvile"
* extension[+].url = "http://hl7.org/fhir/StructureDefinition/no-domain-vso-prepostduktalextension"
