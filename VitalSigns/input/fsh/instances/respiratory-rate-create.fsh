...
* extension[0].url = "http://hl7.org/fhir/StructureDefinition/NoDomainVitalSignsObservationRespirationRateBodyPosition"
* extension[=].valueCoding = $sct#10904000 "Stående/Oppreist"
* extension[+].url = "http://hl7.no/fhir/StructureDefinition/no-domain-vital-signs-observations-respirationregularity-extension"
...
* extension[=].extension[0].url = "http://dips.no/fhir/StructureDefinition/OxygenAdministrationMethod-extension"
