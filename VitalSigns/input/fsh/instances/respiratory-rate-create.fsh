...
* extension[0].url = "http://hl7.org/fhir/StructureDefinition/no-domain-vso-respirationrate-bodypositionextension"
* extension[=].valueCoding = $sct#10904000 "Stående/Oppreist"
* extension[+].url = "http://hl7.no/fhir/StructureDefinition/no-domain-vso-respirationregularityextension"
...
* extension[+].url = "http://hl7.no/fhir/StructureDefinition/no-domain-vso-spontaneousbreathingextension"
...
* extension[+].url = "http://hl7.no/fhir/StructureDefinition/no-domain-vso-inspiredoxygenextension"
