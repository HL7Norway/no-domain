Profile: DipsVitalSignsObservationBodyTemp
Parent: NoDomainVitalSignsObservationBodyTemp
Id: DipsVitalSignsObservationBodyTemp
...
* ^url = "http://dips.no/fhir/StructureDefinition/DipsVitalSignsObservationBodyTemp"
* ^status = #draft
* implicitRules ..0
* language ..0
* text ..0
