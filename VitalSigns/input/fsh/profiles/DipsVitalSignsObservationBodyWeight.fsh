Profile: DipsVitalSignsObservationBodyWeight
Parent: NoDomainVitalSignsObservationBodyWeight
Id: DipsVitalSignsObservationBodyWeight
Title: "DIPS Vital Signs Observation - Body Weight"
Description: "DIPS profile for Body Weight including some extensions"
* ^url = "http://dips.no/fhir/StructureDefinition/DipsVitalSignsObservationBodyWeight"
* ^status = #draft
* implicitRules ..0
* language ..0
* text ..0
