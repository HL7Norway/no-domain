Profile: DipsVitalSignsObservationPulse
Parent: NoDomainVitalSignsObservationPulse
Id: DipsVitalSignsObservationPulse
Title: "DIPS Vital Signs Observation - Pulse"
Description: "DIPS profile for Pulse including some extensions"
* ^url = "http://dips.no/fhir/StructureDefinition/DipsVitalSignsObservationPulse"
* ^status = #draft
* implicitRules ..0
* language ..0
* text ..0
