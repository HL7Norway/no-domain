Profile: DipsVitalSignsObservationRespirationRate
Parent: NoDomainVitalSignsObservationRespirationRate
Id: DipsVitalSignsObservationRespirationRate
Title: "DIPS Vital Signs Observation - Respiration Rate"
Description: "DIPS profile for Respiration Rate including some extensions"
* ^url = "http://dips.no/fhir/StructureDefinition/DipsVitalSignsObservationRespirationRate"
* ^status = #draft
* implicitRules ..0
* language ..0
* text ..0
