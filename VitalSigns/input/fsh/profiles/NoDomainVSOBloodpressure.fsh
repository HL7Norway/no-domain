Profile: NoDomainVSOBloodpressure
Parent: $bp
Id: NoDomainVSOBloodpressure
...
* ^url = "http://hl7.no/fhir/StructureDefinition/no-domain-vso-bloodpressure"
* ^version = "0.9.0000"
* ^status = #draft
* ^date = "2021-05-01"
...
* extension contains
    NoDomainVSOHeadTiltExtension named headTiltAngle 0..1 and
    NoDomainVSOSleepStatusExtension named sleepStatus 0..1 and
    NoDomainVSOCuffSizeExtension named cuffSize 0..1 and
    NoDomainVSOLevelOfExertionExtension named levelOfExertion 0..1 and
    NoDomainVSOBloodPressureBodyPositionExtension named bodyPosition 0..1 and
    NoDomainVSOBloodPressureMeanArterialFormulaExtension named formulaMAPCalc 0..* and
    NoDomainVSOBloodPressureSystolicFormulaExtension named formulaSystolicCalc 0..* and
    NoDomainVSOBloodPressureDiastolicFormulaExtension named formulaDiastolicCalc 0..* and
    NoDomainVSODiastolicEndPointExtension named diastolicEndpoint 0..1
...
//* extension[sleepStatus] from NoDomainVSOSleepStatusValueSet (required)
...
//* extension[cuffSize] from NoDomainVSOCuffsizeValueSet (required)
...
//* extension[bodyPosition] from NoDomainVSOBloodPressureBodyPositionValueSet (required)
...
//* extension[diastolicEndpoint] from NoDomainVSODiastolicEndpointValueSet (required)
...
* note.author[x] ..0
* note.time ..0
* bodySite from NoDomainVSOBloodPressureBodySiteValueSet (required)
...
* bodySite.coding from NoDomainVSOBloodPressureBodySiteValueSet (required)
* bodySite.coding.system from $no-bloodpressurebodysite-valueset (required)
* method from NoDomainVSOBloodPressureMeasurementMethodValueSet (required)
* method ^short = "Method of measurement of blood pressure."
* method.coding from NoDomainVSOBloodPressureMeasurementMethodValueSet (required)
* method.coding.system from NoDomainVSOBloodPressureMeasurementMethodValueSet (required)
...
//* component[MeanArterialPressure].code.coding[MAPCode].system 1..
//* component[MeanArterialPressure].code.coding[MAPCode].system = "http://loinc.org" (exactly)
//* component[MeanArterialPressure].code.coding[MAPCode].code 1..
