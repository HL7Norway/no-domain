Profile: NoDomainVSOBodyHeight
Parent: $bodyheight
Id: NoDomainVSOBodyHeight
...
* ^url = "http://hl7.no/fhir/StructureDefinition/no-domain-vso-bodyheight"
* ^version = "0.9.0000"
* ^status = #draft
* ^date = "2021-05-01"
...
* extension contains NoDomainVSOBodyHeightBodyPositionExtension named bodyPosition 0..1
//* extension[bodyPosition] from NoDomainVSOBodyHeightBodyPositionValueSet (required)
...
// changes to parent cardinality removed
// * category[VSCat].id ..0
