Profile: NoDomainVSOBodyTemp
Parent: $bodytemp
Id: NoDomainVSOBodyTemp
...
* ^url = "http://hl7.no/fhir/StructureDefinition/no-domain-vso-bodytemp"
* ^version = "0.9.0000"
* ^status = #draft
* ^date = "2021-05-01"
...
* extension contains
    NoDomainVSOBodyExposureExtension named bodyExposure 0..1 and
    NoDomainVSODaysSinceMenstruationStartExtension named daysSinceMenstruationStart 0..1 and
    NoDomainVSOLevelOfExertionExtension named levelOfExertion 0..1 and
    NoDomainVSOActiveHeatingExtension named activeHeating 0..1
//* extension[bodyExposure] from NoDomainVSOBodyExposureValueSet (required)
...
* note.author[x] ..0
* note.time ..0
* bodySite from NoDomainVSOBodyTempBodySiteValueSet (required)
...
* bodySite.coding from NoDomainVSOBodyTempBodySiteValueSet (required)
