Profile: NoDomainVSOBodyWeight
Parent: $bodyweight
Id: NoDomainVSOBodyWeight
...
* ^url = "http://hl7.no/fhir/StructureDefinition/no-domain-vso-bodyweight"
* ^version = "0.9.0000"
* ^status = #draft
* ^date = "2021-05-01"
...
* extension contains
    NoDomainVSOClothingStateExtension named clothingState 0..1 and
    NoDomainVSOConfoundingFactorExtension named confoundingFactor 0..1
//* extension[clothingState] from NoDomainVSOClothingStateValueSet (required)
