...
//* extension[heartRhythm] from NoDomainVitalSignsObservationHeartRhythmValueSet (required)
...
//* extension[heartRythmIrregularity] from NoDomainVitalSignsObservationHeartRhythmIrregularityValueSet (required)
