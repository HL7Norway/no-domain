...
* note.author[x] ..0
* note.time ..0
* bodySite from $no-domain-vitalsignsobservation-oxygensaturation-bodysitevalueset (required)
...
* bodySite.coding from $no-domain-vitalsignsobservation-oxygensaturation-bodysitevalueset (required)
