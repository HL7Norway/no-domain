...
Title: "NoDomainVitalSignsObservationBloodpressure"
...
* extension contains
    ...
    NoDomainVitalSignsObservationBloodPressureMeanArterialFormulaExtension named formulaMAPCalc 0..* and
    NoDomainVitalSignsObservationBloodPressureSystolicFormulaExtension named formulaSystolicCalc 0..* and
    NoDomainVitalSignsObservationBloodPressureDiastolicFormulaExtension named formulaDiastolicCalc 0..* and
...
* extension[sleepStatus] from $no-domain-vitalsignsobservation-sleepstatusvalueset (required)
...
* extension[cuffSize] from $no-domain-vitalsignsobservation-cuffsizevalueset (required)
...
* extension[bodyPosition] from $no-domain-vitalsignsobservation-bloodpressure-bodypositionvalueset (required)
...
* extension[diastolicEndpoint] from $no-domain-vitalsignsobservation-diastolicendpointvalueset (required)
...
* note.author[x] ..0
* note.time ..0
* bodySite from $no-domain-vitalsignsobservation-bloodpressure-bodysitevalueset (required)
...
* bodySite.coding from $no-domain-vitalsignsobservation-bloodpressure-bodysitevalueset (required)
* bodySite.coding.system from $no-bloodpressurebodysite-valueset (required)
* method from $no-domain-vitalsignsobservation-bloodpressure-measurementmethodvalueSet (required)
* method ^short = "Method of measurement of blood pressure."
* method.coding from $no-domain-vitalsignsobservation-bloodpressure-measurementmethodvalueSet (required)
