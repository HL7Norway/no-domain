...
Title: "NO Domain VitalSigns Observation - Body Mass Index (BMI)"
Description: """Base profile for Norwegian Vital Signs Observation Body Mass Index information. Calculated measurement which compares a person's weight and height."""
...
* extension contains
    ...
    NoDomainVSObservationBodyMassIndexConfoundingFactorExtension named confoundingFactor 0..1
...
* method from NoDomainVSObservationBodyMassIndexMeasurementMethodValueSet (required)
* method.coding from NoDomainVSObservationBodyMassIndexMeasurementMethodValueSet (required)
