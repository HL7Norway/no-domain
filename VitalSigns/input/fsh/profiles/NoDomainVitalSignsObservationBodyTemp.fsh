...
Title: "NoDomainVitalSignsObservationBodyTemp"
Description: "Basisprofile for Norwegian  VitalSigns Observation Body Temperature information. Used for recording the measurement of an individual's body temperature, which is a surrogate for the core body temperature of the individual."
...
* extension[bodyExposure] from $no-domain-vitalsignsobservation-bodyexposurevalueset (required)
...
* note.author[x] ..0
* note.time ..0
* bodySite from $no-domain-vitalsignsobservation-bodytemp-bodysitevalueset (required)
...
* bodySite.coding from $no-domain-vitalsignsobservation-bodytemp-bodysitevalueset (required)
