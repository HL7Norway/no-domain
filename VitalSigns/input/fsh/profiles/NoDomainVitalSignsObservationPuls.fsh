Profile: NoDomainVitalSignsObservationPuls
Parent: $heartrate
Id: NoDomainVitalSignsObservationPuls
Title: "NO Domain VitalSigns Observation - Puls"
...
* ^url = "http://hl7.no/fhir/StructureDefinition/NoDomainVitalSignsObservationPuls"
* ^version = "0.9.0000"
* ^status = #draft
* ^date = "2021-05-01"
...
* extension contains
    NoDomainVitalSignsObservationPulsRhythm  named pulsRhythm 0..1 and
    ...
    NoDomainVitalSignsObservationHeartRatePulsBodyPosition  named BodyPosition 0..1 and
    NoDomainVitalSignsObservationPulsRhythmIrregularity  named pulsRythmIrregularity 0..1
* extension[pulsRhythm] ^short = "Regularity of the pulse or heart beat."
* extension[pulsRhythm] ^definition = "Regularity of the pulse or heart beat."
...
* extension[pulsRythmIrregularity] ^short = "More specific pattern of an irregular pulse or heart beat."
* extension[pulsRythmIrregularity] ^definition = "More specific pattern of an irregular pulse or heart beat."
...
* bodySite from NoDomainVitalSignsObservationPulsBodySite (extensible)
...
* bodySite.coding from NoDomainVitalSignsObservationPulsBodySite (extensible)
...
* method from NoDomainVitalSignsPulsMeasurmentMethod (extensible)
* method.coding from NoDomainVitalSignsPulsMeasurmentMethod (extensible)