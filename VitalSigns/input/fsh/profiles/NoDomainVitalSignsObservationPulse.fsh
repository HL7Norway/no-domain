...
Title: "no-domain-vitalsignsobservation-pulse"
Description: "Basisprofile for Norwegian  VitalSigns Observation Pulse information. The rate and associated attributes for a pulse."
...
* extension[heartRythm] from $no-domain-vitalsignsobservation-heartrhythmvalueset (required)
...
* extension[heartRythmIrregularity] from $no-domain-vitalsignsobservation-heartrhythmvalueset (required)
