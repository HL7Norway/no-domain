...
* subject 1.. MS
* subject only Reference(Patient or Group or $no-basis-Patient or $vkp-Patient-v090)
...
* subject.identifier.system from http://hl7.no/fhir/ValueSet/vkp-subject-identifier-systems (required) MS
