ValueSet: NoDomainVSOBloodPressureBodyPositionValueSet
Id: NoDomainVSOBloodPressureBodyPositionValueSet
...
* ^url = "http://hl7.no/fhir/ValueSet/no-domain-vso-bloodpressure-bodypositionvalueset"
* ^version = "4.0.0"
* ^status = #draft
* ^experimental = false
