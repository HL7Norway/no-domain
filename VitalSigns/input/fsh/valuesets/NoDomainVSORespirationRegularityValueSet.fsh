ValueSet: NoDomainVSORespirationRegularityValueSet
Id: NoDomainVSORespirationRegularityValueSet
...
* ^url = "http://hl7.org/fhir/ValueSet/no-domain-vso-respirationregularityvalueset"
* ^version = "4.0.0"
* ^status = #draft
* ^experimental = false
