ValueSet: NoDomainVitalSignsBloodpressureBodySiteValueSet 
...
* ^url = "http://hl7.no/fhir/ValueSet/NoDomainVitalSignsBloodpressureBodySiteValueSet"
* ^version = "1.0.0"
* ^status = #draft
* ^experimental = false
...
* SNOMED_CT#51114001 "Intraarterielt"
