ValueSet : NoDomainVitalSignsBloodPressureMeasurementMethodValueSet
...
* ^url = "http://hl7.no/fhir/ValueSet/NoDomainVitalSignsBloodPressureMeasurementMethodValueSet"
* ^version = "1.0.0"
* ^status = #draft
* ^experimental = false
