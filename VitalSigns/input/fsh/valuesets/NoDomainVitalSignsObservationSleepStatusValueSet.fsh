ValueSet: NoDomainVitalSignsObservationSleepStatus 
Id: NoDomainVitalSignsObservationSleepStatus 
Title: "NoDomainVitalSignsObservationSleepStatus"
...
* ^url = "http://hl7.no/fhir/ValueSet/NoDomainVitalSignsObservationSleepStatus"
* ^version = "1.0.0"
* ^status = #draft
* ^experimental = false
