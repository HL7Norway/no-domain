...
- [x] **Thomas** Kaller inn til arbeidsmøte for kvalitetssikring av profilene/verdisettene. Marte, Terje, Arketypegjengen og LAN og meg + Eventuelt med VKP folket.  
- [x] **Thomas** Fikse byggefeil på oDomainVitalSignsPulsMeasurmentMethod og NoDomianVitalSignsObservationHeartRateMeasurementMethod.   
