# NoDomainVitalSignsBloodPressureMeasurementMethod-ValueSet - v0.9.2
...
| | | |
| :--- | :--- | :--- |
| *Official URL*:http://hl7.no/fhir/no-domain/vitalsigns/ValueSet/NoDomainVitalSignsBloodPressureMeasurementMethodValueSet | *Version*:0.9.2 | |
...
Expansion from tx-nordics.fhir.org based on SNOMED CT 51000202101 edition 15-Oct 2025
...
```json
{
  ...
  "url" : "http://hl7.no/fhir/no-domain/vitalsigns/ValueSet/NoDomainVitalSignsBloodPressureMeasurementMethodValueSet",
  "version" : "0.9.2",
